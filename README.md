...
Лабы 9–10 ещё не начаты, папки и репозитории появятся вместе с первым коммитом. По смыслу они встанут раньше в общем порядке: «Чистый PHP» — рядом с OOP-лабой (до RabbitMQ/Laravel), «Чистый JS» — перед Vue (до фреймворков) — номера актуализируем, когда лабы будут готовы.
