...
| 9 | — | 🚧 Чистый PHP — фундамент без фреймворка (в разработке, с нуля) | Базовая | — |
| 10 | — | 🚧 Чистый JavaScript — фундамент без фреймворка (в разработке, с нуля) | Базовая–средняя | — |

Лабы 9–10 ещё не разработаны и даже не составлен план — папки и репозитории появятся вместе с первым коммитом. По смыслу они встанут раньше в общем порядке: «Чистый PHP» — рядом с OOP-лабой (до RabbitMQ/Laravel), «Чистый JS» — перед Vue (до фреймворков) — номера актуализируем, когда лабы будут готовы.
