...
| 9 | [`php`](php) | 🚧 Чистый PHP — фундамент без фреймворка | Базовая | [php-lab](https://github.com/meeymirita/php-lab) |
| 10 | [`js`](js) | 🚧 Чистый JS — фундамент без фреймворка | Базовая–средняя | [js-lab](https://github.com/meeymirita/js-lab) |

Лабы 9–10 ещё не разработаны и даже не составлен план — папки и репозитории уже созданы (заглушки), содержимое появится позже. По смыслу они встанут раньше в общем порядке: «Чистый PHP» — рядом с OOP-лабой (до RabbitMQ/Laravel), «Чистый JS» — перед Vue (до фреймворков) — номера актуализируем, когда лабы будут готовы.
