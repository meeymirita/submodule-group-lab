...
> **Аудит и вычитка (24.09–26.09.2026).** Все методички, кроме пройденной RabbitMQ Lab, вычитаны построчно и исправлены, проверены стыки между лабами (DevOps, фронтенд, бэкенд). PostgreSQL Lab добавлена позже (25.09) и вычитана следом (26.09). Находки, принятые решения и инструкция для повторной вычитки — в [`fixes/`](fixes/README.md), хронология — в [changelog](changelog.html).
