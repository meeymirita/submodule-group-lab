...
Витрина всех работ и их описания — на [`index.html`](index.html): живая версия — [anitech.meeymirita.ru](http://anitech.meeymirita.ru) (GitHub Pages), локально открывается прямо в браузере.
